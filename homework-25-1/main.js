...
function setUserInfoCookie(key, value) {
  // document.cookie = `userInfo=${encodeURIComponent(key)}=${encodeURIComponent(value)}; max-age=10`;
  document.cookie = `userInfo=${encodeURIComponent(key + '=' + value)}; max-age=10; path=/`;
  console.log('Зберігання кукі успішне');
}
