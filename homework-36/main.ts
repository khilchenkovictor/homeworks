 ...
 * 2. Функція має повертати об'єкт, що відповідає типу User. Тип User має бути оголошений з використанням 
 * ключового слова `type` та включати властивості name, age, та isActive.
...
const newUserFalse = createUser('Анна', 25, false)
const newUser2 = createUser('Анна', 25)
console.log(newUser)
...
function getOrderStatus(status: OrderStatus) {
  switch (status) {
    ...
    default: return 'Невідомий статус замовлення'
  }
}
...
// console.log(getOrderStatus(OrderStatus.UnknownStatus));
